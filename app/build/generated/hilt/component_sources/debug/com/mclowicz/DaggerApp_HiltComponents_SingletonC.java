...
import com.mclowicz.recipes.MainViewModel_HiltModules_KeyModule_ProvideFactory;
...
import com.mclowicz.recipes.di.NetworkModule_ProvideOkHttpClientFactory;
import com.mclowicz.recipes.di.NetworkModule_ProvideRecipeApiFactory;
import com.mclowicz.recipes.di.NetworkModule_ProvideRetrofitFactory;
import com.mclowicz.recipes.presentation.main.MainActivity;
...
public final class DaggerApp_HiltComponents_SingletonC extends App_HiltComponents.SingletonC {
  ...
  private void initialize(final ApplicationContextModule applicationContextModuleParam) {
    ...
    this.provideRecipeApiProvider = DoubleCheck.provider(new SwitchingProvider<RecipeApi>(singletonC, 0));
  }
  ...
  private static final class ViewModelCImpl extends App_HiltComponents.ViewModelC {
    ...
    private RecipeApiService recipeApiService() {
      return new RecipeApiService(singletonC.provideRecipeApiProvider.get());
    }
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.mclowicz.recipes.MainViewModel", ((Provider) mainViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.mclowicz.recipes.MainViewModel 
          return (T) new MainViewModel(viewModelCImpl.recipeRepository());
  ...
  private static final class SwitchingProvider<T> implements Provider<T> {
    ...
    public T get() {
      switch (id) {
        case 0: // com.mclowicz.recipes.data.network.RecipeApi 
        return (T) NetworkModule_ProvideRecipeApiFactory.provideRecipeApi(singletonC.provideRetrofitProvider.get());

        case 1: // retrofit2.Retrofit 
        return (T) NetworkModule_ProvideRetrofitFactory.provideRetrofit(singletonC.provideOkHttpClientProvider.get());
